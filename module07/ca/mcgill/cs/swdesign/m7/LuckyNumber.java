...
/**
 * Concrete observer that displays the model data
 * as a Roman numeral in a text field.
 */
class RomanPanel extends Parent implements Observer
{
	private static final String[] LABELS = {"Zero", "i", "ii", "iii", "iv", "v", "vi", "vii", "viii", "ix", "x"};
